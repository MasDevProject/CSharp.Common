...
namespace MasDev.Threading
{
    public sealed class SingleThreadSynchronizationContext : SynchronizationContext
    {
        ...
        BlockingCollection<Job> m_queue = new BlockingCollection<Job>();
        LateArrivalBehavior lateArrivalBehavior;
        SingleThreadSynchronizationContext onFailureForwardTo;
        int firstLateArrivalCallbackExecuted;
        TaskCompletionSource<bool> drainingCompletion = new TaskCompletionSource<bool>();
        ...
        bool EnqueueJob(Job job, bool allowForward)
        {
        ...
        SingleThreadSynchronizationContext lateArrivalSyncCtx;
        bool completed;
        Action onFirstLateArrival;
        ...
        static void Run(Func<Task> func, LateArrivalBehavior lateArrivalBehavior, Action onFirstLateArrival)
        {
            if (func == null)
