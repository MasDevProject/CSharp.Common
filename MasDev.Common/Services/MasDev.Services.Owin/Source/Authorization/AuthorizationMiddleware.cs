	...
	public class AuthorizationMiddleware : OwinMiddleware
	{
		...
		public override async Task Invoke (IOwinContext context)
		{
			...
			if (accessToken != null) {
				...
				injectedToken.Identity = accessToken.Identity;
				injectedToken.CreationUtc = accessToken.CreationUtc;
				injectedToken.ExpirationUtc = accessToken.ExpirationUtc;
				injectedToken.Extra = accessToken.Extra;
				injectedToken.Scope = accessToken.Scope;
			}
