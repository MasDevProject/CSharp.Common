...
namespace MasDev.Data
{
	public class NHibernateRepository : IRepository
	{
		...
		internal INHibernateUnitOfWork Uow;
		...
		{
			Uow = uow as INHibernateUnitOfWork;
			if (Uow == null)
				throw new ArgumentException ("uow must be subclass of " + typeof(INHibernateUnitOfWork).FullName);
			Uow.Start ();
		}
